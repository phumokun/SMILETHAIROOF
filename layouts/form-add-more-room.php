<?php 
    ...
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $query = "SELECT * FROM users_add_hotel WHERE ref_id =" .$id;
...
<form action="layouts/action-add-more-room-db.php?id=<?php echo $_SESSION['id']; ?>" method="post" enctype="multipart/form-data">
    <!-- section  -->
                ...
                <div class="dashboard-content fl-wrap">
                    ...
                    <div class="profile-edit-container">
                        <div class="custom-form">
                            ...
                            <button class="btn color2-bg  float-btn" type="submit" name="submit_add_more_room">เพิ่มห้องพัก<i class="fal fa-paper-plane"></i></button>
                        </div>
                    </div>
                    <!-- profile-edit-container end-->                                
                </div>
