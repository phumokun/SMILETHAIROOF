<?php 
    ...
    if (isset($_SESSION['email'])) {
      ...
      //sql command
      $query = "SELECT * FROM users_add_hotel WHERE status_hotel = 'ไม่ผ่านการตรวจสอบ'";
      //execute sql command
...
<head>
    ...
    <title>Admin หน้าแสดงที่พักไม่ผ่านการตรวจสอบ</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>รายการที่พักไม่ผ่านการตรวจสอบ</h2>
                        </div>
