<ul class="dasboard-menu-wrap">
    ...
    <li><a href="dashboard-list-bookings.php?id=<?php echo $_SESSION['id']; ?>&act=waiting" class="user-profile-act"> <i class="far fa-calendar-check"></i>รายการจอง<span><?php echo $count_wi; ?></span></a>
        <ul>
