<ul class="dasboard-menu-wrap">
    <li>
        <a href="dashboard-myprofile.php?id=<?php echo $_SESSION['id']; ?>" class="user-profile-act"><i class="far fa-user"></i>โปรไฟล์</a>
        <ul>
            <!-- <li><a href="dashboard.php?id=<?php echo $_SESSION['id']; ?>">Dashboard</a></li> -->
            <!-- act คือ การส่งค่า Paremeter ไปยังลิงค์ปลายทาง -->
