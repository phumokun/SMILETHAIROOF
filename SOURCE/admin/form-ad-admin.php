<?php 
    ...
    if (isset($_SESSION['email'])) {
      ...
      //sql command
      $query = "SELECT * FROM users WHERE userlevel = 'admin'";
      //execute sql command
...
<head>
    ...
    <title>Admin หน้าฟอร์มเพิ่มผู้ดูแลระบบ</title>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a data-toggle="tab" href="#ad_admin"><i class="notika-icon notika-bar-chart"></i>Admin</a></li>
                    </ul>
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="ad_admin" class="tab-pane active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-example-wrap mg-t-10">
                        ...
                        <form action="layouts/action-ad-admin.php" method="post">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control input-sm" name="name" placeholder="กรอกชื่อ">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-example-int form-horizental mg-t-15">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <input type="password" class="form-control input-sm" id="con_password" name="con_password" placeholder="Confirm Password">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-example-int mg-t-15">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <button type="submit" name="ad-admin" class="btn btn-success notika-btn-success">ยืนยัน</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <script>
      function del(id) {
        if (confirm('ต้องการลบ Admin นี้ใช่หรือไม่')) {
            window.location.href = "layouts/action-del-admin.php?id=" + id;
        }
      }
  </script>       
</body>
